#Assignment 1 for Python Programming
#Shenoy Siddharth - shenoy22@purdue.edu
#Ramana Prabhu Sana - rsana@purdue.edu

#THIS IS THE CORE PROGRAM.
# The user is given the option to choose between basic,engineering,business calculator or to quit the program.
# Based on the choice, the submodule is called and the calculations are performed till the user decides to quit the program.
# Error Handling- If any of the values are entered incorrectly, the program will ask for a valid value.
print("Welcome to calculator (or 'q' to exit)")

def calculator():
    while True:
        print("Please select category:\n"
              "1 for Basic Calculator Operations\n"
              "2 for Engineering Calculations\n"
              "3 for Business Calculations\n"
              "Enter 'q' to exit")
...
# This is a submodule for basic calculator. The user is expected to enter two numbers and provide the operator.
# The program will calculate based on the operator.
# Error Handling- If the operator is entered incorrectly, the program will ask for a valid operator.
def operator_1():
    while True:  # Added for looping in this menu
        print("Please input the mathematical operator:\n"
              ...
              "4 for Division (/)\n"
              "5 for Modulus (mod) – Remainder of division\n"
              "6 for Exponentiation (^) – Raise a number to a power")
        input_mathematical_operation = input()
        if input_mathematical_operation < "7":
            ...
            print("Please input valid operator, not a number, not negatives, letters or symbols")
            continue
...
# This is a submodule for engineering calculator. The user can calculate area/surface are of a shape,volume of a shape or use it for unit conversion.
# The program will request which of the conversions are needed.
# Based on the area and volume entered the program will request for the shape. The program will then request for values with respect to the shape and provide the output.
# If the user requests for unit conversion the user will be requested for the unit value and the unit and the program will do the conversion.
# Error Handling- If any of the values are entered incorrectly, the program will ask for a valid value.
def operator_2():
    while True:  # Added for looping
        print("Please confirm the category:\n"
              "1 for Geometric calculations\n"
...
def operator_2_1():
    while True:  # Added for looping
        print("Please confirm the parameter to calculate\n"
              ...
              "4 for Area or Volume of Cube\n"
              "5 for Area or Volume of Cylinder\n"
              "6 for Area or Volume of Cone")
...
def operator_2_2():
    while True:  # Added for looping
        print("1 for meters to feet\n"
              "2 for kilograms to pounds\n"
...
# This is a submodule for business calculator. The user can calculate compound interest and break even point.
# The program will provide option between compound interest and break even point.
# If compound interest is chosen, the program will request for the amount,interest and time period. Based on the values and time period, the program will then provide the result.
# If the user requests for break even point, the user will be requested for the fixed costs, variable costs per unit and selling price per unit and the program will do the calculations.
# Error Handling- If any of the values are entered incorrectly, the program will ask for a valid value.
def operator_3():
    while True:  # Added for looping
        print("Please confirm the parameter:\n"
              "1 for Compound interest calculation\n"
              "2 for break-even point for a business")
        ...
        if input_parameter_business == "1":
            ...
            try:
                ...
                if principal >= 0 and annual_rate >= 0 and period >= 0:
                    ...
                    print("Please input non-negative values for principal, rate, and years")
                    continue  # retry in same menu
            except ValueError:
                print("Please input valid numerical values")
                continue  # retry in same menu
