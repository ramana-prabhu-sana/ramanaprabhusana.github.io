  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-full border border-lime-400/30 bg-lime-400/[0.08] px-2.5 py-1 text-[11px] font-medium text-lime-200 transition-colors hover:border-lime-400/60 hover:bg-lime-400/[0.15] focus:outline-none focus:ring-2 focus:ring-lime-400/40"
      >
